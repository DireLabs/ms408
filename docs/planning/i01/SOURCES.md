...
**Verified reference counts (ZL3b) — use as parser integrity checks:** 227 pages; 5,389 loci; `$I`: H=129, S=25, B=19, P=17, Z=12, C=11, A=8, T=7; `$L`: A=114, B=83, unassigned=30; `$H` present on all 227 pages (113/46/33/27/7 for scribes 1–5, plus f115r `@`).
